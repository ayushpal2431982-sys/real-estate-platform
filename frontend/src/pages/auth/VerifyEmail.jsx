                        ...
                        {!emailFromState && (
                            <div>
                                ...
                                <input type="email" value={email}
                                    ...
                                    placeholder='name@company.com' required className={s.input} />
                            </div>
                        )}
                        <div>
                            <label className={s.label}>Verification Code</label>
                            <input type="text" maxLength="6" value={code}
                                onChange={(e) => setCode(e.target.value)} // ✅ No duplicate
                                placeholder='123456' required className={s.codeInput} />
                        </div>
