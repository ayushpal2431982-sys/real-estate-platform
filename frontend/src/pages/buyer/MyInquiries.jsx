      ...
      >
        <div className={s.mb12}>
          ...
          <p className={s.textMuted}>
            {isSeller
              ? "Review and response to intrest in your properties"
        ...
        {inquiries.length === 0 ? (
          <div className={s.cardPremiumPy24Px8TextCenter}>
            ...
            <p className={s.textMutedMb8}>
              {isSeller
                ...
                : "You haven't contacted and sellers yet. Intrested in a property? Send an inquiry!"}
            </p>
          ...
          <div className={s.flexColGap6}>
            {myInquiriesStyles.map((inq) => (
              <div key={inq._id} className={s.inquiryMain}>
                <div className={s.iconWrapper}>
                  <HiHome className={s.inconSize} />
                </div>
                ...
                <div className={s.actions}>
                    <Link to={`/property/${inq.property?._id}`}
