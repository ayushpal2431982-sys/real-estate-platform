...
const SellerDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // ✅ FIX 1: Use array destructuring, not object destructuring, for Promise.all
                ...
                setStats(statsRes.data.properties || statsRes.data);
    ...
    <div className={s.listingsSection}>
        <div className={s.listingsHeader}>
            ...
            <div className={s.searchWrapper}>
                ...
                {/* ✅ FIX 3: onChange (camelCase) instead of onchange */}
        ...
        {filteredProperties.length === 0 ? (
            ...
            <div className={s.propertiesGrid}>
                {/* ✅ FIX 4: Use filteredProperties instead of properties */}
        ...
        <div className={s.tipsWidget}>
            ...
            <div className={s.tipsList}>
                <div className={s.tipCardHighViews}>
                    ...
                    {/* ✅ FIX 2: s.tipTextHighViews instead of bare tipTitleHighViews */}
