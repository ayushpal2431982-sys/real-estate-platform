      ...
      <div className={s.innerContainer}>
        <div className={s.header}>
          ...
          <p className={s.subheading}>
            Fill in the details below to reach thousands of potentials buyers.
          </p>
        </div>
        <form onSubmit={handleSubmit} className={s.form}>
          ...
          <div className={s.section}>
            <SectionTitle title="Content & Description" />
            <div className={s.contentGroupLarge}>
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Luxury 3BHK Appartment in Downtown"
                  className={s.input}
                  required
                />
              </div>
